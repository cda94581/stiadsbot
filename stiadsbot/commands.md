...
| ------- | ------- | ---- | ----- | ----------- | -------------------- | ---------------- |
| `8ball` | N/A | Fun | `8ball <Query>` | Talk to the 8ball and ask a question. | N/A | WIP |
| `addxp` | N/A | Leveling | `addxp <User ID> <Amount of Levels to Add> <Amount of XP to Add>` | Add xp to a user. Autoroles will afterwards need to be manually assigned. | Administrator | WIP |
...
| `dog` | N/A | Fun | `dog` | Get a random dog picture from a `.json` file. This does not access an internet database, so images are limited. | N/A | WIP |
...
| `hug` | N/A | Action | `hug <@Mention Users>` | Hug a user. | N/A | WIP |
...
| `nuzzle` | N/A | Action | `nuzzle <@Mention Users>` | Nuzzle a user. | N/A | WIP |
| `ping` | N/A | Info | `ping` | Checks the response time for STIADS👀 Bot, and if it's still alive. | N/A | WIP |
| `plans` | `future` | Info | `plans` | Get the plans for the future of STIADS👀 Bot. | N/A | WIP |
| `poke` | N/A | Action | `poke <@Mention Users>` | Poke a user. | N/A | WIP |
...
| `pout` | N/A | Action | `pout <@Mention Users>` | Pout at a user. | N/A | WIP |
...
| `removexp` | N/A | Leveling | `removexp <User ID> <Amount of Levels to Remove> <Amount of XP to Remove>` | Removes XP from a user. Autoroles will need to be manually removed. | Administrator | WIP |
| `resetxp` | N/A | Leveling | `resetxp <User ID>` | Reset the XP of a user. | Administrator | WIP |
| `revive` | `revive-chat` | Fun | `revive` | Revives the chat...maybe? | N/A | WIP |
...
| `setxp` | N/A | Leveling | `setxp <User ID> <Level> <XP>` | Set the xp of a specific user. Autoroles will need to be manually assigned or removed. Take note of integer limits, if it fails to work. | Administrator | WIP |
| `slap` | N/A | Action | `slap <@Mention Users>` | Slap a user. | N/A | WIP |
| `stare` | N/A | Action | `stare <@Mention Users>` | Stare at a user. | N/A | WIP |