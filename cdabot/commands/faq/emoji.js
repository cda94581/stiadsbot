...
module.exports = {
	...
	execute(message, args) {
		...
		message.channel.send(new Discord.MessageEmbed().setColor('#44434d').setTitle('Save this to your resource pack -> `fonts/glyph_E0.png`').setThumbnail('https://github.com/cda94581/cdabot/blob/main/Bot/assets/faq/emoji/glyph_E0.png?raw=true'));
		message.channel.send(new Discord.MessageEmbed().setColor('#44434d').setTitle('Save this to your resource pack -> `fonts/glyph_E1.png`').setThumbnail('https://github.com/cda94581/cdabot/blob/main/Bot/assets/faq/emoji/glyph_E1.png?raw=true'));
	}
}