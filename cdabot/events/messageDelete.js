...
module.exports = message => {
	...
	const embed = new Discord.MessageEmbed().setColor('#00cccc').setTitle(`Message by ${message.author.tag} Deleted in #${message.channel.name}`).setDescription(desc).setTimestamp(Date.now());
