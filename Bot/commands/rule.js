...
module.exports = {
	...
	execute(message, args) {
		...
		var ruleEmbed;
		switch (amount) {
			case 1: ruleEmbed = new Discord.MessageEmbed().setColor('#ff0000').setTitle(':one: **Be Respectful**').setDescription('We want to create and uphold a caring and loving environment for all members. Harassment, bullying, toxicity and all other forms of disrespect will not be tolerated. Please avoid all forms of controversial discussion, such as politics or religion'); message.channel.send(ruleEmbed); break;
			...
			case 8: ruleEmbed = new Discord.MessageEmbed().setColor('#ff0000').setTitle(':eight: **Use Common Sense**').setDescription('If you wouldn\'t do something IRL, why do it here? Use your common sense to decide what\'s right and wrong if it\'s not clearly stated'); message.channel.send(ruleEmbed); break;
