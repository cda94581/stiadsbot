...
module.exports = {
	...
	execute(message, args) {
		...
		// announcementsEmbed = new Discord.MessageEmbed().setColor('#ff0000').setTitle('2021/01/10 - 1').setDescription('- Updated `ping` to send the latency\n- **STIADS:eyes: Bot** now has a github repository, located at https://github.com/cda94581/stiadsbot/\n- Added `plans` to get a list of future plans for the bot').setTimestamp('2021-01-10T05:00:00.000Z'); //2021/01/10 - 1
		// announcementsEmbed = new Discord.MessageEmbed().setColor('#ff0000').setTitle('2021/01/18 - 1').setDescription('- Polls now can automatically resize options and reactions!').setTimestamp('2021-01-18T05:00:00.000Z'); //2021/01/24 - 1
		announcementsEmbed = new Discord.MessageEmbed().setColor('#ff0000').setTitle('2021/01/10 - 1').setDescription('- Music is now in BETA! Check pins in <#760619010424438814> for more information').setTimestamp('2021-01-24T07:30:00.000Z'); //2021/01/24 - 1
