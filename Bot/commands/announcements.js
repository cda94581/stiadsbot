...
module.exports = {
	...
	execute(message, args) {
		...
		announcementsEmbed = new Discord.MessageEmbed().setColor('#ff0000').setTitle('2021/01/18 - 1').setDescription('- Polls now can automatically resize options and reactions!').setTimestamp('2021-01-18T05:00:00.000Z');
